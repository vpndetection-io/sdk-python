...
from ...models.entitlement_error import EntitlementError
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 401:
        response_401 = EntitlementError.from_dict(response.json())

        return response_401

    if response.status_code == 403:
        response_403 = EntitlementError.from_dict(response.json())

        return response_403

    if response.status_code == 503:
        response_503 = EntitlementError.from_dict(response.json())
